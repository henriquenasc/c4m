...
<body class="login">
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <form action="<?= base_url(); ?>/SignInController/signAuth" method="post" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <div class="position-relative">
                        <input id="password" name="passwd" type="password" class="form-control" required>
                ...
                <div class="form-group form-action-d-flex mb-3">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label m-0" for="rememberme">Lembre-me</label>
                    </div>
                    <button href="#" class="btn btn-primary col-md-5 float-right mt-3 mt-sm-0 fw-bold">Entrar</button>
                </div>
