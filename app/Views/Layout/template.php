								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= site_url('') ?>/assets/img/jm_denis.jpg" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= site_url('') ?>/assets/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= site_url('') ?>/assets/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= site_url('') ?>/assets/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img"> 
												<img src="<?= site_url('') ?>/assets/img/profile2.jpg" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
